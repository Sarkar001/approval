...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> SARKAR RANJHA")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/Sarkar001/approve/main/File.txt').text
			if basesplit in plr:
				key = basesplit
		...
		print ("""
             ...
             \033[1;31m   __    _____ _____ _____
             \033[1;32m   |  |  |     |   __|     |
            \033[1;33m    |  |__|  |  |  |  |  |  |
             \033[1;34m   |_____|_____|_____|_____|
            
   [❤] FACEBOOK   :            Q BATOOO              
   [❤] WHATSAPP   :            +92315*******23          
   [❤] GITHUB     :            WO KAYA HOTA HA                  
   [❤] TOOLS      :            JUST-NOW-UID   \033[1;31mV=1.0.0    \033[1;32m
 \033[1;32m
"""        )
